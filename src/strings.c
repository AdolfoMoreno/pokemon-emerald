...
const u8 gMenuText_Teach[] = _("TEACH");
...
const u8 gText_EventTickets[] = _("Event Tickets");
const u8 gText_EventTicketsOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_EventTicketsOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_BuyableStones[] = _("Buyable stones");
const u8 gText_BuyableStonesOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_BuyableStonesOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_BagOnlyHMs[] = _("Bag only HMs");
const u8 gText_BagOnlyHMsOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_BagOnlyHMsOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_EasyEvolutions[] = _("Easy Evolutions");
const u8 gText_EasyEvolutionsOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_EasyEvolutionsOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_EventTicketsAddedToBag[] = _("Event tickets were added\nto the bag.");
const u8 gText_EventTicketsBagTooFull[] = _("Bag too full for event\nticket items.");
